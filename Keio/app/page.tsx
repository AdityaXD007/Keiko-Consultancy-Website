        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="relative h-[260px] sm:h-[340px] lg:h-[400px] rounded-2xl overflow-hidden shadow-md"
            >
              <img
                src="/brand/Icon.jpeg"
            ...
            {objectives.map((objective, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="bg-white rounded-xl p-5 sm:p-6 shadow-md hover:shadow-xl transition-all border border-gray-100"
                >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {whyChooseUs.map((reason, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white rounded-xl p-5 sm:p-6 border-2 border-yokohama-blue shadow-md hover:shadow-xl transition-shadow"
              >
